  ...
  methods: {
    loginWithKakao() {
      Kakao.Auth.authorize({
        redirectUri: 'http://localhost:5000/auth_kakao',
    ...
    naverLogin() {
      ...
      console.log(`https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${client_id}&redirect_uri=${redirectURI}&state=${state}`)
    },
    async loginProcess () {
      try {
